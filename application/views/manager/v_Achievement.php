...
<div class="panel panel-primary">
    <div  class="panel-heading" style=" font-size: 28px; "> <i class="fa fa-star-half-empty"></i> Achievement Editor</div>
...
function numberWithCommas(x) {
	...
	function set_Data(){
		...
		var Options = { "0" : "User Achievement"};
		$.ajax({
