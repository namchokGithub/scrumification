...
<body class="hold-transition skin-blue sidebar-mini /*sidebar-collapse*/" style="font-family: Prompt; ">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo site_url("home"); ?>" class="logo">
      ...
      <span class="logo-mini"><b>OSSD</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>OSSD </b>Camp</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
			  <img  style="object-fit: cover; object-position: center;" src="<?php echo base_url('assets/dist/img/user/'.$Profile[2].'.jpg'); ?>" class="user-image" alt="User Image" onerror="this.onerror=null;this.src='<?php echo base_url('assets/dist/img/user/unknown-who.jpg'); ?>';">
	  ...
	  <div class="modal-body">
		<div class="row" id="list_role">
			...
			if(empty($Profile[1])){?>
				<div class="col-lg-4 col-xs-6">
				  ...
				  <div class="small-box bg-yellow">
					...
					<a href="#" class="small-box-footer" data-dismiss="modal" aria-label="Close">Choose This Role<i class="fa fa-arrow-circle-down"></i>
					</a>
				  </div>
				</div>
			<?php }
			...
			<div class="col-lg-4 col-xs-6">
			  ...
			  <div class="small-box bg-yellow">
				<div class="inner">
				  <p style=" font-weight: 700; font-size: 28px; "><?php echo $Role; ?></p>
				</div>
				<div class="icon">
				  <i class="ion ion-person"></i>
				</div>
				<a onclick='setCookie("Role","<?php echo $Role; ?>",999);location.reload();'class="Role_button small-box-footer" style=" cursor: pointer; ">Choose This Role<i class="fa fa-arrow-circle-down"></i>
				</a>
			  </div>
			</div>
			<?php } ?>
